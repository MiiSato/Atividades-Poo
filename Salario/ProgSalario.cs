...
namespace TarefaSalario
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Usa o For pra repetir o pedido dos dados dos funcionarios de acordo com o número de funcionários pra registro
            for (int i = 0; i < N; i++)
            {
                Console.WriteLine("\nFuncionário #" + (i + 1) + ":");
                //Dados do ID
            ...
            //Define pelo ID, o funcionário que irá receber o aumento
            ...
            //condições se existe ou não o número indicado para o aumento no banco de registros

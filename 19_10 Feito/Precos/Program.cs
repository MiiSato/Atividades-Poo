...
namespace Precos
{
    class Program
    {
        ...
        {
            //defina a quantidade dos produtos
            Console.Write("Digite a quantidade de produtos: ");
            int n = int.Parse(Console.ReadLine());
            //Array, classe Produto com tamanho [n]
            Produto[] vect = new Produto[n];
            //For com variável inicial de i = 0, entra com a informação do usuário, e cria um novo Produto no [i] do array, com o nome e preço que foram digitados
            for (int i = 0; i < n; i++)
            {
                Console.Write("\nNome do produto " + (i + 1) + ": ");
            ...
            //variável double vai somando os valores
            double sum = 0.00;
            ...
            //O programa nao fecha automaticamente
            Console.ReadKey();
        }
    }
}
